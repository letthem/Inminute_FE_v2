...
export const AboutPage = () => {
  ...
  return (
    <>
      <section
        className={`bg-bg flex flex-col w-full h-full transition-opacity duration-500 ease-in-out font-nanum ${
          isVisible ? 'opacity-100' : 'opacity-0'
        }`}
      >
        <NavBar />
        <div className="flex mt-[62px] ml-[199px]">
          ...
          <div className="flex flex-col mt-[101px] ml-[60px] text-[20px] font-[300] leading-[190%]">
