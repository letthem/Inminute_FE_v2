...
export const CardItem = () => {
  ...
  return (
    <div>
      <div className="min-w-[280px] h-[187px] border border-gray03 rounded-[20px] bg-white flex font-nanum leading-[22px] flex-col">
        ...
        <p className="ml-6 mt-4 text-mainBlack text-[20px] font-bold ">
          브랜드 아이덴티티 전략 회의
        </p>
        <div className="relative mx-6 my-5">
          ...
          >
            <span className="text-gray06 font-pretendard font-normal text-[13px]">
              ...
              핵심 가치를 새로운 브랜드화 했다. 새로운 브랜드의 핵심 가치와 시각적 요소를 정의하는
              전략을 수립하고 새로운 브랜드의 핵심 가치를 새로운 브랜드화 했다.
            </span>
          </div>
          {/* 하단 고정 회색 오버레이 */}
