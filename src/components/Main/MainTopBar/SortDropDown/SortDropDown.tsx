...
export const SortDropdown: React.FC<SortDropdownProps> = ({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <div
        className={`w-[120px] h-[100px] absolute top-full mt-3 right-6 bg-white rounded-[10px] shadow-[0_0_4px_0_rgba(0,0,0,0.25)] z-20 transition-all duration-200 ease-in-out overflow-hidden ${
