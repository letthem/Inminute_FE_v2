        ...
        <section className="mt-5 ml-12">
          ...
          <div className="mt-3 mr-[120px] max-w-[760px] rounded-[10px] bg-[#ECECEC]">
            <p className="font-normal text-[14px] font-pretendard leading-[25.2px] py-[15px] px-[18px]">
              오프라인 마케팅 쪽은 이벤트와 프로모션에 집중하고 있는데 이번 주에 교체한 제품체험
              이벤트는 생각보다 많은 고객이 참여하여 성공적으로 마무리 되었고 다음 달에 대형
              쇼핑몰에서 팝업스토어를 운영할 예정이다
            </p>
          </div>
        </section>
        ...
        <section className="ml-12 mt-[74px]">
          ...
          <div className="mt-5 flex">
            ...
            <span className="font-pretendard font-normal text-[13px] leading-[23px] mr-[120px]">
              브랜드 아이덴티티는 명확한 비전과 일관된 메시지가 중요하며, 고객 경험과 직접적으로
              연결되어야 한다고 강조
            </span>
          </div>
          <div className="mt-3 flex">
            ...
            <span className="font-pretendard font-normal text-[13px] leading-[23px] mr-[120px]">
              고객 세분화를 기반으로 한 맞춤형 마케팅이 타겟 고객의 욕구에 부합하는 브랜드 메시지
              전달에 필수적이라고 언급
            </span>
          </div>
          <div className="mt-3 flex">
            ...
            <span className="font-pretendard font-normal text-[13px] leading-[23px] mr-[120px]">
              브랜드 인지도를 높이기 위해 간결하면서도 강렬한 비주얼 아이덴티티가 중요하다고 주장
            </span>
          </div>
          <div className="mt-3 flex">
            <span className="min-w-10 font-extrabold text-[13px] mr-6">유재인</span>
            <span className="font-pretendard font-normal text-[13px] leading-[23px] mr-[120px]">
              브랜드 철학이 제품에 일관되게 반영되어, 고객이 제품을 통해 브랜드 경험을 직관적으로
              느껴야 한다고 강조
            </span>
          </div>
          <div className="mt-3 flex">
            ...
            <span className="font-pretendard font-normal text-[13px] leading-[23px] mr-[120px]">
              브랜드 가치를 소셜 미디어 등 디지털 채널을 통해 꾸준히 전달하는 것이 고객 접점에서의
              브랜드 인식에 중요하다고 설명
            </span>
          </div>
        </section>
