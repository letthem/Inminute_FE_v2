...
const platforms = [
  {
    ...
    color: 'text-[#0B5CFF]',
    className:
      'w-[100px] h-[26px] mt-[40px] mb-[27px] s1400:w-[230px] s1400:h-[60px] s1400:mt-[90px] s1400:mb-[81px] s1600:w-[285px] s1600:h-[74px] s1600:mt-[110px] s1600:mb-[98px] mx-auto',
  },
  {
    logo: webex,
    name: 'WEBEX',
    color: 'text-[#22CDE4]',
    className:
      'w-[134px] h-[51px] mt-[26px] ml-[-2px] mb-4 s1400:w-[299px] s1400:h-[114px] s1400:mt-[64px] s1400:ml-0 s1400:mb-[53px] s1600:w-[364px] s1600:h-[138px] s1600:mt-[77px] s1600:ml-1 s1600:mb-[67px]',
  },
  {
    logo: googleMeet,
    name: 'MEET',
    color: 'text-[#4CBA6E]',
    className:
      'w-[133px] h-[25px] mt-10 mb-7 s1400:w-[290px] s1400:h-[56px] s1400:mt-[100px] s1400:mb-[75px] s1600:w-[360px] s1600:h-[70px] s1600:mt-[114px] s1600:mb-[98px] mx-auto',
  },
  {
    logo: microsoftTeams,
    name: 'TEAMS',
    color: 'text-[#6B73DE]',
    className:
      'w-[133px] h-[32.4px] mt-[38px] ml-1 mb-[22.8px] s1400:w-[300px] s1400:h-[73px] s1400:mt-[90px] s1400:ml-[9px] s1400:mb-[68px] s1600:w-[366px] s1600:h-[89px] s1600:mt-[104px] s1600:ml-[10px] s1600:mb-[89px]',
  },
];
